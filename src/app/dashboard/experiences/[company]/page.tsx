...
export default async function CompanyExperiencesPage({
  ...
  if (!company) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center">
        ...
        <Link href="/dashboard/experiences" className="text-primary hover:underline">Return to Repository</Link>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-8">
      <div>
        <Link href="/dashboard/experiences" className="inline-flex items-center text-sm font-medium text-muted-foreground hover:text-primary transition-colors mb-4">
